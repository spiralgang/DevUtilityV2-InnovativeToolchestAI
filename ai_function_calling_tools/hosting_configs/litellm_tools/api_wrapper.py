...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/litellm_tools.log'),
...
# Tool wrapper class
class LitellmtoolsWrapper:
    """Wrapper class for litellm_tools functionality"""
    
    def __init__(self):
        self.tool_name = "litellm_tools"
        self.logger = logger
        self._load_tool()
    ...
    def _load_tool(self):
        ...
        try:
            ...
            # Example: from src.litellm_tools import main_function
...
tool_wrapper = LitellmtoolsWrapper()
...
async def root():
    """Root endpoint"""
    return {
        'message': 'Welcome to Litellm Tools API',
        'endpoints': [
            '/health',
            '/function-call',
            '/tool',
