...
# -*- coding: utf-8 -*-
"""
API Wrapper for crewai_tools
CrewAI function calling tools
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/crewai_tools.log'),
...
# Tool wrapper class
class CrewaitoolsWrapper:
    """Wrapper class for crewai_tools functionality"""
    
    def __init__(self):
        self.tool_name = "crewai_tools"
        self.logger = logger
        self._load_tool()
    ...
    def _load_tool(self):
        ...
        try:
            ...
            # Example: from src.crewai_tools import main_function
...
tool_wrapper = CrewaitoolsWrapper()
...
async def root():
    """Root endpoint"""
    return {
        'message': 'Welcome to Crewai Tools API',
        'endpoints': [
            '/health',
            '/function-call',
            '/tool',
